...
```bash
node tests/test-map-editor.js && node tests/test-game.js && node tests/test-stage1-map.js && node tests/test-battle.js && node tests/test-save.js && node tests/test-fairy.js
```
